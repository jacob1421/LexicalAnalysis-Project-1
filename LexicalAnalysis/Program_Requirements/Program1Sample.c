...
/*
 >	"Sample" source code for COSC-4310, Spring 2020
...
int main(void)
{
	int int0Var, nbr_out_123, year2020 = 0;
	...
	strcpy(Array_of_25_Char,"COSC-4310, Spring 2020");		/*	rolling now, with tab chars embedded in comment...	*/		X3_86Z = tabch;
	...
	ResultNBR = (float)(76.612 - (flt_IN - int0Var) *
		(00.303107 / sqrt(year2020 + int0Var ) - 01.020425 * pi + 043.474677));		/* 2 tab chars after semicolon */
